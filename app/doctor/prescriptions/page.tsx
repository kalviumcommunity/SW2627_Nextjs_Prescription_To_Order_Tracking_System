        ...
        <div className="fixed inset-0 z-50 overflow-y-auto bg-black/50 flex items-center justify-center p-4">
          <div className="bg-white rounded-lg max-w-2xl w-full max-h-[90vh] overflow-y-auto shadow-2xl border border-gray-200">
            <div className="px-6 py-4 border-b border-gray-100 flex items-center justify-between bg-gray-50/50">
              <div>
                <h3 className="text-lg font-bold text-gray-900">Prescription Record</h3>
                <p className="text-xs font-mono text-gray-500 mt-0.5">
                  ID: #{selectedPrescription.id} &bull; Authored{' '}
            ...
            <div className="p-6 space-y-6">
              ...
              <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 p-4 bg-gray-50 rounded-lg border border-gray-100">
                ...
                <div className="sm:text-right">
                  <p className="text-xs font-semibold text-gray-500 uppercase">Fulfillment Status</p>
              ...
              <div>
                ...
                <div className="mt-1 p-3.5 bg-blue-50/50 border border-blue-100 rounded-md text-sm text-gray-800 font-medium">
              ...
              <div>
                <h4 className="text-xs font-semibold text-gray-500 uppercase tracking-wider mb-2">
                  Itemized Medications ({selectedPrescription.prescriptionMedicines.length})
                </h4>
                ...
                <div className="p-4 bg-green-50 border border-green-200 rounded-lg space-y-2">
                  <div className="flex items-center justify-between">
                    <span className="text-xs font-bold text-green-900 uppercase">
                      Pharmacy Fulfillment Record
                    </span>
                    <span className="text-xs text-green-700">
                      Dispensed: {formatDate(selectedPrescription.fill.filledAt)}
                    </span>
                  </div>
                  ...
                  {selectedPrescription.fill.notes && (
                    <p className="text-xs text-green-700 bg-white/60 p-2.5 rounded border border-green-100">
                      <strong>Fulfillment Notes:</strong> {selectedPrescription.fill.notes}
                    </p>
                  )}
                </div>
              )}
